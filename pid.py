...
class PID(object):
    ...
    def __init__(
        ...
        :param is_enabled: Whether the controller should be enabled (auto mode) or not (manual mode)
    ...
    def __repr__(self):
        return (
            ...
            "output_limits={self.output_limits!r}, is_enabled={self.is_enabled!r}, "
    ...
    def set_is_enabled(self, enabled, last_output=None):
        """
        ...
        """
        if enabled and not self._is_enabled:
